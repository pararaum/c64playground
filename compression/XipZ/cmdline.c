...
const char *gengetopt_args_info_usage = "Usage: XipZ [OPTIONS]...";
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'a':	/* crunching algorithm to use.  */
          ...
          break;
        case 'j':	/* address to jump to (-1 = load address).  */
        
        
          if (update_arg( (void *)&(args_info->jump_arg), 
               &(args_info->jump_orig), &(args_info->jump_given),
